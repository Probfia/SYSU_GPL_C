...
\newcommand{\ExpeName}{实验CC1+B 热辐射谱测量与普朗克黑体辐射定律的验证}
...
\textbf{【实验目的】}
\begin{enumerate}
 \item[1.]定量测量黑体辐射谱，验证导致量子论产生的普朗克定律；
\begin{enumerate}
    \item 黑体辐射谱的特征
    \item 黑体辐射谱与温度的关系
\end{enumerate}

 \item[2.] 学习使用多种光谱仪测量范围更宽的光谱
 \begin{enumerate}
    \item 光谱仪的校正
    \item 光谱的衔接
 \end{enumerate} 
...
\textbf{【原理概述】}\par
该实验验证黑体辐射的功率谱$I(\lambda)d\lambda$，其理论结果由普朗克黑体辐射定律给出
\beq
I(\lambda) d\lambda = \frac{2\pi h c^2}{\lambda^5} \frac{1}{e^{\frac{ch}{\lambda k_B T}} - 1}
\eeq
这是量子论的诞生，它是由假设电磁辐射的最小能量单位为$h \nu$推出的。\par
实验方面，该实验利用溴钨灯的电流-温度对应关系调整温度，在红外和可见光波段测量溴钨灯的辐射谱。
\emptyline
\textbf{【实验前思考题】}
\begin{enumerate}
 \item[1.] (问题1)
